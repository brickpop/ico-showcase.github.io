...
///  Contract. This version specifically acts as a TvrboTokenSale manager for raising
...
///  non-profit TvrboTokenSale. This contract effectively dictates the terms of the
///  funding round.
...
/// @notice `finalizeFunding()` ends the TvrboTokenSale by calling setting the
